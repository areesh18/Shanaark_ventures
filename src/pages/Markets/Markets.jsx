...
const ICON_MAP = {
  "Graphic Design": (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.554C21.965 6.012 17.461 2 12 2z" /></svg>
  ),
  SEO: (
  ...
  "Web Design": (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M3 3h18v18H3zM3 9h18M9 21V9" /></svg>
  ),
  "Branding Kit Design": (
...
const Markets = () => {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-(--color-bg-primary) pt-24 sm:pt-32 pb-24 sm:pb-32 overflow-hidden">
      <div className="max-w-8xl mx-auto px-5 sm:px-6">
        ...
        <div className="max-w-7xl mx-auto gsap-pillars-container" key={activeMarket}>
