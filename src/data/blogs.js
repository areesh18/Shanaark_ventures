export const blogs = [
  {
    id: 1,
    slug: "surinames-emerging-energy-economy",
    ...
    excerpt:
      "As Suriname's energy sector grows, opportunities are emerging for construction firms, logistics providers, hospitality operators, technology companies, and professional service providers.",

    content: `# Suriname's Emerging Energy Economy: What Local Businesses Should Be Doing Right Now
...
- Interior and fit-out companies
...
Behind every major project is a system most people do not see: logistics.

If construction is the visible structure, logistics is what makes it possible.
...
Not all energy-related growth looks industrial.

One of the most underestimated sectors in oil-driven economies is hospitality.
